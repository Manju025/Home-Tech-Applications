...
function setupImageUpload() {
    ...
    fileInput.addEventListener('change', function(e) {
        ...
        reader.onload = function(evt) {
            ...
            hint.textContent = 'âœ“ Image ready';
...
function renderProductsAdmin() {
    ...
    container.innerHTML = products.map(product => `
        <div class="product-admin-card">
            ...
            <div class="product-admin-card__price">â‚¹${product.price.toLocaleString()}</div>
...
window.openProductModal = function(productId) {
    ...
    modalBody.innerHTML = `
        <div class="product-detail">
            ...
            <h3>${product.name}</h3>
            <div class="product-detail__price">â‚¹${product.price.toLocaleString()}</div>
            <div class="product-technologies">
                ${product.tags.map(tag => `<span class="tech-tag">${tag}</span>`).join('')}
            </div>
...
window.openOrderModal = function(productId) {
    ...
    orderSummary.innerHTML = `
        ...
        <div class="order-item order-total">
            ...
            <span id="orderTotalDisplay">â‚¹${product.price.toLocaleString()}</span>
        </div>
    `;
...
function updateOrderSummary() {
    ...
    if (totalDisplay) totalDisplay.textContent = `â‚¹${total.toLocaleString()}`;
}
